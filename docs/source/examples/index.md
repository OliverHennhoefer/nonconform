...
| [Derandomized conformal e-values](derandomized_e_values.md) | Random calibration splits make selections unstable | Uniformly averaged split evidence and e-BH mask |
