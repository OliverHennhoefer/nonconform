...
| Labeled outlier workflows | `IntegrativeConformalDetector` for labeled inlier/labeled outlier OOD testing with split conditional-FDR selection | [Integrative Conformal](https://oliverhennhoefer.github.io/nonconform/user_guide/integrative_conformal/) |
